...
/**
 * This is the item provider adapter for a {@link restInPeace.Response} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResponseItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addCodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Response_code_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Response_code_feature",
								"_UI_Response_type"),
						RestInPeacePackage.Literals.RESPONSE__CODE, true, false, false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Response_description_feature"),
	...
	public String getText(Object object) {
		...
		return getString("_UI_Response_type") + " " + response.getCode();
	}

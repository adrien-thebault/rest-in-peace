...
public class ResponseImpl extends MinimalEObjectImpl.Container implements Response {
	...
	protected EClass eStaticClass() {
		return RestInPeacePackage.Literals.RESPONSE;
	}
	...
	public void setCode(int newCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestInPeacePackage.RESPONSE__CODE, oldCode, code));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RestInPeacePackage.RESPONSE__DESCRIPTION,
